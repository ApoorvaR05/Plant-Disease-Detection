    ...
    return (
        <div className="max-w-md mx-auto py-16 px-4">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center">
                ...
                <p className="text-slate-500 mb-8 text-center">Login to your account to detect plant diseases and view history.</p>
                ...
                <p className="mt-6 text-sm text-slate-600">
                    Don't have an account? <Link to="/signup" className="text-brand-green-600 font-bold hover:underline">Sign up</Link>
                </p>
            </div>
        </div>
    );
